...
describe('getNextClosedAt()', () => {
  ...
  it.each`
    openingHoursString                 | date                      | expectedResult
    ${closedOnHolidays.string}         | ${mondayMidday}           | ${'Mo 17:30'}
    ${closedOnHolidays.string}         | ${mondayEvening}          | ${null}
    ${closedOnHolidays.string}         | ${saturdayMidday}         | ${null}
    ${closedOnHolidays.string}         | ${saturdayEvening}        | ${null}
  ...
  it('throws an error given a string with public holidays and no isPublicHoliday function', () => {
    expect(() => getNextClosedAt(closedOnHolidays.string, mondayMorning)).toThrow();
  });
